...
def openfile(filename):
    ...
    if os.path.exists(path + filename):
        append_write = 'w' # write from beginning if file already exists (i.e overwrite is desired)
    else:
        append_write = 'a' # append if file doesn't exist before running the program
